...
//vars
	var no_slide = 1;
	var logoSrc = '<div class="logobrachole"><img src="img/dj-wodzirej-wesele-logo.svg" alt="dj for wedding logo"></div>';
	var logos = ['<div class=watchword_banner><p>Hochzeiten</p></div>',
							logoSrc,
							'<div class=watchword_banner><p>Party</p></div>',
							logoSrc];
